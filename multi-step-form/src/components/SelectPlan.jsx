  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <button
          className={`${
            selectedPlan === 'pro' ? ' border-purple-900 bg-purple-100/30' : ''
          } flex h-20 w-full items-center  justify-start gap-6 rounded-lg border border-gray-400  px-4`}
      ...
      <div className='flex items-center justify-center gap-4 py-32'>
        ...
        <Switch
          ...
          onChange={setEnabled}
          className='relative
          inline-flex h-8 w-16 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-blue-900 transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75'
        >
          <span
            aria-hidden='true'
